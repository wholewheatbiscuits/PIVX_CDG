...
Who can vote., i.e. holders, stakers, voting node owners, masternode owners.
Voting weights, if any, i.e. 0.25 weight per PIV for holders, 0.5 weight per PIV for stakers, 1.0 weight per PIV for masternode owners.
How many “voting layers” there are, i.e. single layer, separate layers for each group.
The vote thresholds for passing/failing proposals, and whether thresholds are different for some categories, i.e. higher threshold required to modify transaction fee burning.
...
Stakers with at least 1,000 PIV staked can vote with 0.8 vote weight per PIV. The purpose of this voting weight group is to incentivize people to accumulate and hold onto larger quantities of PIV, even if they can’t or don’t want to buy enough PIV to own a masternode. This can also have a positive effect on PIVX price by locking up PIV.
Stakers can vote with 0.65 vote weight per PIV. The purpose of this voting weight group is to incentivize people to contribute to the PIVX network with additional voting power over those who do not contribute to the PIVX network.
Holders can vote with 0.5 vote weight per PIV. The purpose of this voting weight group is to incentivize people to buy, use, and hold onto PIV by giving them some voting power, and to allow participation in governance regardless of how much PIV a person owns.
